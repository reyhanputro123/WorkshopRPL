...
public class CustomerRegister_JF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Register_Button.setBackground(new java.awt.Color(51, 153, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerRegister_JF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerRegister_JF().setVisible(true);
            }
        });
    }
